...
class MenuSeeder {
  async run () {
    ...
    const menus = [
      ...
      {ni_id:153,menu_name:"编辑菜单",parent_id:150,controller:"/menu/edit/:id",run_status:1,menu_sort:100},
      {ni_id:154,menu_name:"删除菜单",parent_id:150,controller:"/menu/destroy/:id",run_status:1,menu_sort:100},
      ...
      {ni_id:209,menu_name:"删除栏目",parent_id:200,controller:"/article/categoryDestroy/:id",run_status:1,menu_sort:100},
      ...
      {ni_id:352,menu_name:"增加会员",parent_id:350,controller:"/member/add",run_status:0,menu_sort:100},
      {ni_id:353,menu_name:"编辑会员",parent_id:350,controller:"/member/edit/:id",run_status:1,menu_sort:100},
      {ni_id:354,menu_name:"删除会员",parent_id:350,controller:"/member/destroy/:id",run_status:1,menu_sort:100},
      {ni_id:355,menu_name:"等级列表",parent_id:350,controller:"/member/level",run_status:0,menu_sort:100},
      {ni_id:356,menu_name:"增加等级",parent_id:350,controller:"/member/levelAdd",run_status:0,menu_sort:100},
      {ni_id:357,menu_name:"编辑等级",parent_id:350,controller:"/member/levelEdit/:id",run_status:1,menu_sort:100},
      {ni_id:358,menu_name:"删除等级",parent_id:350,controller:"/member/levelDestroy/:id",run_status:1,menu_sort:100},
      {ni_id:359,menu_name:"增加地址",parent_id:350,controller:"/member/addressNew",run_status:1,menu_sort:100},
      {ni_id:360,menu_name:"编辑地址",parent_id:350,controller:"/member/addressEdit/:id",run_status:1,menu_sort:100},
      {ni_id:361,menu_name:"删除地址",parent_id:350,controller:"/member/addressDestroy/:id",run_status:1,menu_sort:100},
      {ni_id:362,menu_name:"会员购物车",parent_id:350,controller:"/member/cart",run_status:1,menu_sort:100},
      {ni_id:363,menu_name:"保存购物车",parent_id:350,controller:"/member/cartSave",run_status:1,menu_sort:100},
      ...
      {ni_id:453,menu_name:"编辑角色",parent_id:450,controller:"/manager/roleEdit/:id",run_status:1,menu_sort:100},
      {ni_id:454,menu_name:"删除角色",parent_id:450,controller:"/manager/roleDestroy/:id",run_status:1,menu_sort:100},
      ...
      {ni_id:457,menu_name:"编辑管理员",parent_id:450,controller:"/manager/userEdit/:id",run_status:1,menu_sort:100},
      {ni_id:458,menu_name:"删除管理员",parent_id:450,controller:"/manager/userDestroy/:id",run_status:1,menu_sort:100},
