...
class MenuSeeder {
  async run () {
    ...
    const menus = [
      ...
      {ni_id:455,menu_name:"增加管理员",parent_id:450,controller:"/manager/add",run_status:0,menu_sort:100},
      {ni_id:456,menu_name:"管理员列表",parent_id:450,controller:"/manager/list",run_status:0,menu_sort:100},
      {ni_id:457,menu_name:"编辑管理员",parent_id:450,controller:"/manager/edit",run_status:1,menu_sort:100},
      {ni_id:458,menu_name:"删除管理员",parent_id:450,controller:"/manager/destroy",run_status:1,menu_sort:100},
